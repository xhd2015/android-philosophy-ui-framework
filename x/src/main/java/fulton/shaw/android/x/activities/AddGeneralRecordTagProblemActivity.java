...
public class AddGeneralRecordTagProblemActivity extends AddForDatabaseActivity {
    @Override
    protected Object[][] getDatabaseViewAdapterUnderlyingData() {
        return new Object[][]{
                ...
                {SqliteHelper.TABLE_GENERAL_RECORDS, SqlUtil.COL_MAIN_TAG, AdapterFieldsInfo.SHOW_TYPE_NOT_SHOWN, null, AdapterFieldsInfo.PROCESS_TYPE_HIDDEN_USE_DEFAULT_VALUE, AdapterFieldsInfo.VALUE_TYPE_STRING, null, SqlUtil.TAG_PROBLEM},
                ...
                {SqliteHelper.TABLE_GENERAL_RECORDS, SqlUtil.COL_DETAIL, AdapterFieldsInfo.SHOW_TYPE_DEFAULT_DESCRIPTIVE_EDITTEXT, "内容", null, null, null, null},
                {SqliteHelper.TABLE_GENERAL_RECORDS, SqlUtil.COL_CAUSING, null, "原因", null, null, null, null},
